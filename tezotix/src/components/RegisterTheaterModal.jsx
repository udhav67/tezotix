...
export default function RegisterTheaterModal({
    ...
    return (
        <div
            ...
            className="absolute top-0 left-0 z-[100] w-screen h-screen flex justify-center items-start pt-[12vh] md:pt-[25vh] bg-black/70 md:px-20"
        >
            <div
            ...
            >
                ...
                <div className="flex flex-col gap-[30px] flex-wrap w-full md:w-3/4 max-h-[calc(70vh-150px)]">
                    ...
                    <div className="flex flex-row gap-4 items-center w-full">
                        <p className="font-poppins text-base text-white/70 font-medium">
                            *This includes one-time registration fees of 10 ꜩ
                        </p>
                    </div>
